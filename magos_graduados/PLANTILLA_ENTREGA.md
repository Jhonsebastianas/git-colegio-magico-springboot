...
1.  **¿Usaste Inteligencia Artificial para resolver los retos (del 1 al 4)?**
    *Respuesta:* (Si, para el reto 3 y 4)
...
2.  **¿Para qué específicamente te fue útil la IA? (Ej. para entender la lógica de las anotaciones, para explicar los errores de Java, para que hiciera el código desde cero)**
    *Respuesta:* (En el reto 3 me ayudo para la validacion del hechizo oscuro usando equals y para el reto 4 a entender mejor los Endpoints)

3.  **¿Qué fue lo que más se te dificultó al trabajar con la Arquitectura por Capas en Spring Boot?**
    *Respuesta:* (lo que mas se me dificulto fue entender en si la distribucion y comunicacion de las capas, la manager, la de servicies, etc)

4.  **¿Qué aprendiste sobre la creación de APIs REST y el uso de Jakarta en esta academia?**
    *Respuesta:* (Aprendi la definicion y usos de varios conceptos claves de esta arquitectura, tambien aprendi mas sobre la creacion de las Apis, los Endpoints y como se escuchan las capas )
